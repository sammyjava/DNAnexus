...
main() {
    ...
    makeblastdb -dbtype prot -in db.fasta
    echo "...done."

    # run blastp on all the available cores
    cores=`nproc`
    echo "Running blastp with $cores cores..."
    blastp -num_threads $cores -db db.fasta -query query.fasta $opts > output
    echo "...done."
